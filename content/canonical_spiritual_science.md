# TRUTH CODE XYZ | SPIRITUAL SCIENCE
...
| Aspect | Principle | Type |
| --- | --- | --- |
| Unity / Interpersonal | Love Your Neighbour as Yourself (Ayesu’s command) | Ethical / Heart |
| Agency / Power | You Are the Creator of Your Reality | Manifestation / Mind |
| Presence / Process | The Way Is the Win | Path / Body |
| Frequency / Faith | Faith Over Fear | Abundance / Spirit |
| Healing / Depth | Light & Distortion Work Is Freedom | Trauma / Spirit |
| Awareness / Insight | Sacred Stillness — Be Still, and Know | Meditation / Truth |
| Universal / Cosmic Law | Sacred Mirrors | Alignment / Design |
...
- Light Masculine: truth, boundary, responsibility, clean action, stewardship.

- Light Feminine: presence, compassion, receptivity, gentleness, creativity.

- Distorted Masculine: harshness, control, rigidity, domination, perfectionism.

- Distorted Feminine: collapse, avoidance, indulgence, appeasement, manipulation.
...
- Light Masculine ↔ adaptive sympathetic mobilisation: clear goal, boundaried action within your window of tolerance.

- Light Feminine ↔ adaptive parasympathetic (ventral) regulation: presence, social engagement, recovery.

- Distorted Masculine = sympathetic overdrive (fight/rigidity). Distorted Feminine = dorsal collapse (freeze/avoidance).
...
> “My timing cannot be stolen.”
> “Peace proves I’m aligned with the Most High.”
...
>  When peace rises after word and act, your signal is coherent. Creation obeys coherence.
...
| Gift | Essence | Industries / Expressions | Non-Monetary Expressions |
| --- | --- | --- | --- |
| Service | Meeting needs with humility and diligence. | Hospitality, healthcare, community work, military, public service. | Volunteering, caring for family, mentoring youth. |
| Communication | Translating ideas into words that inspire, teach, or connect. | Writing, speaking, media, sales, teaching. | Storytelling in family settings, hosting discussions, leading study groups. |
| Craft | Excellence in making, building, or repairing tangible things. | Carpentry, tailoring, engineering, architecture, culinary arts, product design, artisan trades. | Home cooking, handmade gifts, home projects, preserving cultural traditions, building sacred spaces. |
| Leadership | Guiding people with vision and accountability. | Business leadership, politics, coaching, military command. | Organising community events, leading local initiatives. |
| Athleticism | Channelling physical vitality, discipline, and embodied presence. | Sports, fitness, performance arts, movement coaching. | Physical play with children, disciplined routines, training the body. |
| Intellect | Solving problems through analysis, study, and strategic thought. | Science, research, law, philosophy, data analysis. | Personal study, pattern recognition, cultural and political analysis, helping friends plan and problem-solve. |
| Spiritual Sensitivity | Perceiving divine movements and spiritual realities. | Ministry, intercession, spiritual guidance, prophetic work. | Quiet prayer for others, sensing needs before they’re spoken, naturally knowing the truth. |
| Creativity | Bringing beauty, novelty, or unique perspective into existence. | Art, music, design, advertising, innovation sectors. | Decorating spaces, creative hobbies, new traditions, generating fresh ideas and angles. |
| Connection | Building and maintaining meaningful relationships. | Networking, diplomacy, HR, community organising. | Hosting gatherings, introducing people, building local trust. |
| Systems | Bringing structure, clarity, and harmony to complexity. | Operations, logistics, accounting, project management. | Organising home spaces, planning events, family scheduling. |
...
| Distortion (Specific Expression) | Root Distortion | Fruit Of Spirit | Potential Gift Channels |
| --- | --- | --- | --- |
| Arrogance | Pride | Faithfulness | Leadership, Service |
| Stubbornness | Pride | Patience | Intellect, Order |
| Superiority complex | Pride | Kindness | Connection, Compassion |
| Image-protection / defensiveness | Pride | Faithfulness | Communication, Leadership |
| Vanity / status-chasing | Pride | Gratitude | Creativity, Connection |
| Disrespect / slander | Pride | Faithfulness | Communication, Leadership |
| Dishonesty / spin | Pride | Faithfulness | Communication, Leadership |
| Hypocrisy (double standard) | Pride | Faithfulness | Leadership, Compassion |
| Lack | Greed | Gratitude | Service, Spiritual Sensitivity |
| Hoarding | Greed | Gratitude | Service, Order |
| Exploitation | Greed | Faithfulness | Leadership, Compassion |
| Opportunism without integrity | Greed | Faithfulness | Leadership, Order |
| Waste of shared resources | Greed | Goodness | Order, Service |
| Withholding key info | Greed | Faithfulness | Connection, Service |
| Jealousy | Envy | Gratitude | Compassion, Service |
| Resentment of others’ success | Envy | Love | Connection, Communication |
| Rivalry / sabotage | Envy | Peace | Leadership, Order |
| Chronic comparison | Envy | Peace | Spiritual Sensitivity, Intellect |
| Backbiting / undermining | Envy | Kindness | Communication, Connection |
| Overindulgence (food/info/pleasure) | Gluttony | Self-Control | Order, Craft |
| Binge consumption / scrolling | Gluttony | Self-Control | Spiritual Sensitivity, Order |
| Clutter / accumulation | Gluttony | Goodness | Order, Craft |
| Hedonistic drift (purposeless pleasure) | Gluttony | Goodness | Leadership, Intellect |
| Sensory excess numbing | Gluttony | Peace | Spiritual Sensitivity, Creativity |
| Obsession with money or power | Lust | Self-Control | Leadership, Service |
| Objectification | Lust | Love | Compassion, Connection |
| Manipulation through desire | Lust | Self-control | Leadership, Service |
| Boundary crossing | Lust | Self-Control | Order, Communication |
| Compulsive novelty / affairs | Lust | Faithfulness | Connection, Service |
| Fantasy-escape (sexualised) | Lust | Joy | Spiritual Sensitivity, Creativity |
| Laziness | Sloth | Peace | Craft, Service |
| Chronic procrastination | Sloth | Self-Control | Leadership, Order |
| Learned helplessness | Sloth | Faithfulness | Service, Leadership |
| Apathy / numbness | Sloth | Joy | Creativity, Compassion |
| Spiritual neglect | Sloth | Faithfulness | Spiritual Sensitivity, Connection |
| Neglect of self | Sloth | Love | Athleticism, Compassion |
| Neglect of duties | Sloth | Faithfulness | Order, Craft |
| Recklessness | Pride | Self-Control | Intellect, Leadership |
| Impulsiveness | Wrath | Patience | Spiritual Sensitivity, Order |
| Irritability / explosive anger | Wrath | Self-Control | Leadership, Communication |
| Vengefulness | Wrath | Kindness | Compassion, Leadership |
| Contempt | Wrath | Love | Communication, Connection |
| Passive aggression | Wrath | Faithfulness | Order, Communication |
| Destructive manipulation | Wrath | Goodness | Leadership, Communication |
| Harsh punishment | Wrath | Patience | Compassion, Leadership |
| Cruelty | Wrath | Kindness | Service, Leadership |
| Spite / schadenfreude | Wrath | Love | Connection, Spiritual Sensitivity |
| Revenge plotting | Wrath | Peace | Leadership, Compassion |
| Betrayal | Greed | Faithfulness | Service, Leadership |
| Exploiting trust | Greed | Faithfulness | Connection, Compassion |
| Naivety | Sloth | Goodness | Intellect, Service |
...
> "The heart is deceitful above all things and desperately wicked: who can know it? I the Lord search the heart and examine the mind, to reward each person according to their conduct."
> — Jeremiah 17:9–10
...
| Energy Centre | Distortion | Fruit of Alignment | Signs of Misalignment | Signs of Alignment |
| --- | --- | --- | --- | --- |
| Root | Greed | Gratitude | Obsession with security, fear of lack, hoarding resources | Trust in provision, generosity, steady commitment |
| Sacral | Lust | Joy | Pleasure-seeking without fulfilment, compulsive indulgence | Healthy pleasure, deep connection, creative flow |
| Solar Plexus | Wrath | Patience, Self-Control | Short temper, controlling behaviour, resentment | Calm authority, measured action, resilience under pressure |
| Heart | Envy | Love, Kindness | Comparison, bitterness, inability to celebrate others | Warmth, compassion, celebrating others’ wins as your own |
| Throat | Pride | Faithfulness | Refusal to admit fault, over-defensiveness, manipulation through words | Honest self-expression, humility, keeping one’s word |
| Third Eye | Gluttony | Goodness | Overconsumption of information or experiences without purpose | Clarity, discernment, intentional use of time and energy |
| Crown | Sloth | Peace | Spiritual apathy, avoidance of responsibility, chronic disengagement | Deep stillness, spiritual discipline, readiness to act in divine timing |
...
- *Virtue:* Playful collaboration, creative exploration, building community through shared curiosity.

- *Distortion:* Chaotic distraction, gossip, aimless busyness that avoids deeper purpose.

- *Mirror Question:* Are you contributing to meaningful connection or just generating noise?

*🦁 **The Lion***

- *Virtue:* Noble leadership, courage, protective strength used in service to the group.

- *Distortion:* Prideful domination, controlling behaviour, demanding loyalty through fear.

- *Mirror Question:* Are you leading with honour or with ego?

*🐘 **The Elephant***

- ***Virtue Expression:** Emotional memory, loyalty to family and history, protective wisdom.*

- ***Distortion Expression:** Inability to release old pain, staying trapped in past grievances.*

- *Mirror Question:* Are you honouring your past or letting it define your present?

*🐺 **The Wolf***

- ***Virtue Expression:** Pack harmony, clear roles, mutual support and interdependence.*

- ***Distortion Expression:** Tribal exclusion, gatekeeping, hostility to anyone “outside the pack.”*

- *Mirror Question:* Are you fostering belonging or creating division?

*🐦 **The Bird***

- ***Virtue Expression:** Adaptability, shared space, communication that strengthens the collective.*

- *Distortion:* Competitive hoarding, noisy self-interest, turning community into rivalry.

- *Mirror Question:* Are you co-creating or competing for attention and resources?

*🐍 **The Snake***

- ***Virtue Expression:** Transformation, shedding what no longer serves, embracing rebirth.*

- ***Distortion Expression:** Secret manipulation, hidden agendas, using change to conceal motives.*

- *Mirror Question:* Are you evolving transparently or hiding behind transformation?

*🐃 **The Ox***

- ***Virtue Expression:** Steadfast service, strength applied to purpose, grounded reliability.*

- *Distortion:* Blind labour, carrying burdens that don't belong to you, self-sacrifice without discernment.

- *Mirror Question:* Are you serving purpose or exhausting yourself without direction?

*🐅 **The Tiger***

- ***Virtue Expression:** Solitary power, self-reliance, inner focus that fuels mastery.*

- ***Distortion Expression:** Isolation, loneliness, rejecting help to protect pride.*

- *Mirror Question:* Is your solitude sacred or is it your escape?

*🦉 **The Owl***

- ***Virtue Expression:** Spiritual wisdom, patient observation, discernment before action.
> **Distortion Expression:** Detached superiority, withholding insight to avoid involvement.*

- *Mirror Question:* Are you perceiving with compassion or hiding behind detachment?

*🐜 **The Ant***

- ***Virtue Expression:** Disciplined contribution, purposeful labour toward shared goals.*

- ***Distortion Expression:** Mindless obedience, losing individuality to conform.*
...
*Fear (Can be both)* — You're reading a real risk, standing at the edge of courage, or being shown a growth your spirit is ready for (Activation) — or fear is inflating something that isn't actually there: imagined threats, catastrophic stories rehearsed in the head, dread bleeding into things that don't warrant it (Distortion).

Mirror Question: "Which kind of fear is this — a real risk to prepare for, the edge of courage to step through, a growth my spirit is pointing me toward, or a threat I'm rehearsing that isn't actually here?"

Aligned move: Set a boundary / take a prudent step; then act in trust.

*Anxiety (Can be both)* — I'm projecting painful futures (Distortion) or recognising a need to prepare or ground before action (Activation).

Mirror Question: "What story am I rehearsing? What is actually true now?"

Aligned move: Return to present data; breathe, ground; choose one next step.

*Dread (Can be both)* — Dread as the alarm bell pointing at something real you need to face — your conscience signalling before the avoidance compounds (Activation). Or using the dread as a reason to keep avoiding rather than to act — letting it deepen into a weight, when the signal was meant to move you (Distortion).

Mirror Question: "What is dread pointing me toward — and am I letting the signal move me, or using it to stall further?"

Aligned move: Receive the signal as the gift it is; schedule what needs doing; prepare kindly and clearly.

**Boundary signals (dignity & limits)**

Anger (Can be both) — A value or boundary was crossed (Activation if channelled for justice; Distortion if reactive without clarity).

Mirror Question: "Which value? What boundary is needed?"

Aligned move: Express calmly; set/restore the boundary.

*Irritation/Frustration (Can be both)* — Irritation pointing at a real friction in your work — a process gap, a skills gap, or overcommitment that genuinely needs addressing (Activation). Or you've slipped out of peace, and small things that wouldn't normally matter are getting under your skin — putting weight on what doesn't deserve it (Distortion).

Mirror Question: "Have I lost my inner peace — or is this a real signal that my process, skill, or load needs adjusting?"

Aligned move: Return to peace first as a test — if the irritation lifts, that was the work. If it remains, address the real friction: clarify expectations, improve process, or reduce load.

*Resentment (Can be both)* — Resentment pointing at a real imbalance — unspoken needs, or an agreement you can't honestly sustain — asking to be named and renegotiated (Activation). Or you're holding the grievance instead of addressing it — letting it quietly build into bitterness, playing the martyr, expecting the other person to read your mind (Distortion).

Mirror Question: "What did I promise that I can't sustain — or what am I holding silently when I should be speaking?"

Aligned move: Renegotiate honestly; stop quiet martyrdom.

**Value/meaning signals (conscience & purpose)**

Guilt (Can be both) — I violated a value or commitment (Activation if leading to amends; Distortion if it becomes self-punishment).

Mirror Question: "What needs apology or repair?"

Aligned move: Confess, make amends, choose differently.

*Shame (Can be both)* — A gap between what you know is true and how you actually showed up — the conscience calling you back to alignment (Activation). Or a lie about your worth — condemning the self underneath the action, rather than correcting the action itself (Distortion).

Mirror Question: "Is this shame pointing me to realign — or telling me a lie about who I am?"

Aligned move: If there's a real action to repair, realign without self-hate; let it purify, not punish. If the shame is condemning who you are rather than what you did, reject the lie; remember your identity; seek truthful mirrors.

Regret (Can be both) — A lesson asking to be integrated (Activation if used to adjust; Distortion if it traps you in the past).

Mirror Question: "What will I do differently next time?"

Aligned move: Write the protocol; practice it.

**Loss & tenderness signals (attachment & love)**

Sadness/Grief (Can be both) — Something mattered and is changing or gone (Activation if it deepens compassion; Distortion if it becomes withdrawal from life).

Mirror Question: "What needs honouring, and what needs release?"

Aligned move: Ritualise farewell; keep love, release clinging.

*Loneliness (Can be both)* — Loneliness pointing at something real — either a need for honest connection (reach out for someone you can be known by), or a gap in your inner capacity to be with yourself (the signal showing you it's time to learn stillness) (Activation). Or you're not receiving the signal — pushing people away because you expect a life without friction (real relationships always carry some), or filling the space with noise instead of honest presence with people or yourself (Distortion).

Mirror Question: "Is this loneliness asking me to reach out for connection — or to learn to be still with myself?"

Aligned move: Reach out intentionally where you need connection (and let real relationships include friction). Sit in the stillness where you need yourself — solitude becomes generative when you can be present to it.

**Comparison & scarcity signals**

*Envy/Jealousy (Can be both)* — I've forgotten my path or pace (Distortion) or I'm recognising a desire ready to be cultivated (Activation).

Mirror Question: "What desire in me needs commitment?"

Aligned move: Turn comparison into a plan; bless their win, build yours.

*Inadequacy (Can be both)* — A real signal that a specific capability needs strengthening — pointing you to learn, train, or get mentorship (Activation). Or confusing "I haven't learned this yet" with "I am insufficient as a person" — treating a skill gap as a verdict on identity (Distortion).

Mirror Question: "Is this a skill I haven't built yet — or am I confusing the gap with a verdict on who I am?"

Aligned move: Build the skill — and refuse the identity verdict that says the gap is who you are.

**Overload signals (capacity & rhythm)**

*Overwhelm (Can be both)* — A real signal that you've taken on more than you can carry — pointing you to prune, delegate, or delay (Activation). Or blaming the volume of inputs instead of choosing what matters most — staying stuck because everything feels equally urgent (Distortion).

Mirror Question: "Is the volume genuinely beyond my capacity — or am I refusing to choose what matters most?"

Aligned move: Prune; choose the vital few; breathe.

*Numbness/Apathy (Can be both)* — A temporary survival-mode signal — your system has paused feeling so you can recover before more can be processed (Activation). Or prolonged disconnection — you stopped feeling because somewhere you stopped telling the truth, to yourself or someone else (Distortion).

Mirror Question: "Is my system protecting me with a temporary pause — or have I gone numb because I stopped telling the truth?"

Aligned move: Honest check-in; micro-wins; time in nature.

**Activation & alignment signals (green lights)**

(All here are Activation unless twisted into escapism)

*Peace (Can be both)* — You are aligned; nothing inside is pulling against itself. The next step — action or stillness — feels obvious (Activation). Or avoidance dressed as peace — withdrawing from people, conflict, or challenge, and calling the resulting quiet "peace." True peace can hold engagement; counterfeit peace requires you to keep the world at arm's length (Distortion).

Mirror Question: "Am I at peace because I'm aligned — or because I've avoided everything that might disturb me?"

Aligned move: If true, maintain pace; don't over-tinker. If avoidance, name what you're withdrawing from; step back in with the boundary or the courage it requires.

*Gratitude (Can be both)* — You're seeing reality rightly — noticing what's actually there, not what's missing (Activation). Or gratitude weaponised to silence honest pain — "I should just be grateful" used to override legitimate grief, anger, or the conscience asking you to change something. It can also become an anchor to less than what you're called to — using thankfulness as a reason to settle, to stop asking, to call premature peace on a calling that's still moving you forward (Distortion).

Mirror Question: "Is this gratitude opening my eyes to what's true — or am I using it to silence what I should be naming, or to settle for less than what's calling me?"

Aligned move: If true, acknowledge, share, build on it. If silencing, stop performing the feeling; let yourself name the grief, anger, or correction first. If settling, receive what is, then keep moving toward what's calling — gratitude isn't a stopping point, it's an open eye.

*Joy (Can be both)* — Life is flowing through you, not just to you — you've become a channel, not just a container (Activation). Or pleasure-chasing dressed as joy — overindulging in food, substances, sex, or any escapist behaviour to manufacture the feeling. True joy is received; the chase always extracts a cost, then asks for more (Distortion).

Mirror Question: "Is this joy flowing through me — or am I chasing a feeling I'm trying to manufacture from something that's hollowing me out?"

Aligned move: If true, create, play, bless others. If chase, name what you're really hunting and what it's costing you; return to the practices that let real joy flow in.

*Curiosity (Can be both)* — A door is opening — something specific is drawing your attention, and the pull is gentle, not desperate (Activation). Or curiosity as scatter or escape — chasing novelty to feel alive, using "exploration" as a reason to avoid commitment, or feeding the appetite for information without depth (Distortion).

Mirror Question: "Is this curiosity opening a door I'm meant to walk through — or am I using it to avoid the depth I'm already supposed to be in?"

Aligned move: If true, low-risk test; follow data and peace. If scatter, name what you're avoiding by chasing the new thing; return to the work that's already in front of you.

*Conviction (Can be both)* — A clean inner *yes* or *no* has arrived — no need to talk yourself into it, no need to negotiate (Activation). Or false certainty dressed as conviction — being sure of something that isn't actually true, or wielding the certainty to judge, dominate, or shut down dialogue (Distortion).

Mirror Question: "Is this conviction holding steady in the truth — or have I confused my own preference, ego, or bias with the voice of truth?"

Aligned move: If true, act swiftly and cleanly. If false, pause; test it against humility, scripture, and counsel — truth tolerates examination, ego does not.

*Awe/Reverence (Can be both)* — You've caught a glimpse of how big the Most High's order is — and your own life falls into proper scale beside it (Activation). Or directing reverence at something that doesn't deserve it — losing yourself in a person, a movement, or a spectacle, rather than seeing them in proper scale beneath the Most High (Distortion).

Mirror Question: "Am I being moved by truth and the Most High's order — or being swept up in something that's borrowed His seat?"

Aligned move: If true reverence, slow down; integrate; worship. If misdirected, name what you're actually worshipping; return your reverence to its rightful place.
